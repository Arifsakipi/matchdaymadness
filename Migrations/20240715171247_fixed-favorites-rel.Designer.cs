...
{
    [DbContext(typeof(DB))]
    [Migration("20240715171247_fixed-favorites-rel")]
    partial class fixedfavoritesrel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FavoritesFavorites", b =>
                {
                    ...
                    b.HasKey("FavoritePlayerid", "FavoriteTeamid");

                    b.HasIndex("FavoriteTeamid");

                    b.ToTable("FavoritesFavorites");
                });
            ...
            modelBuilder.Entity("FavoritesFavorites", b =>
                {
                    b.HasOne("MatchdayMadness2.Models.Favorites", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MatchdayMadness2.Models.Matches", b =>
                {
                    b.HasOne("MatchdayMadness2.Models.Teams", "AwayTeam")
                        .WithMany("AwayMatches")
                        .HasForeignKey("AwayTeamid")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MatchdayMadness2.Models.Teams", "HomeTeam")
